...
const en: I18nStrings = {
  overview: {
    ...
    hooksAndServices: 'Hooks & Services',
  },
  component: {
    props: 'Props',
    noProps: 'No props defined.',
    methods: 'Methods',
  ...
  memo: {
    ...
    import: 'Import',
    importFile: 'Import memo file',
    placeholder: 'Write a memo for this page...',
    editorLabel: 'Memo editor',
    addMemo: 'Add Memo',
    saveMemo: 'Save Memo',
    noMemos: 'No memos for this page yet',
    shared: 'Shared',
    personal: 'Personal',
    deleteMemo: 'Delete memo',
    clearPersonal: 'Clear Personal',
  ...
  common: {
    ...
    autoGenerated: 'This documentation was automatically generated from source code analysis.',
    ...
    classes: 'Classes',
    exports: 'Exports',
    completeApiReference: 'Complete API reference for {{name}}.',
  },
  theme: {
    returns: 'Returns',
    parameters: 'Parameters',
...
const ko: I18nStrings = {
  overview: {
    ...
    changelog: '변경 이력',
    components: '컴포넌트',
    hooksAndServices: '훅 & 서비스',
  },
  component: {
    props: '프로퍼티',
    noProps: '정의된 프로퍼티가 없습니다.',
    methods: '메서드',
    dependencies: '의존성',
  },
  endpoint: {
  ...
  memo: {
    ...
    exportAll: '전체 내보내기',
    import: '가져오기',
    importFile: '메모 파일 가져오기',
    placeholder: '이 페이지에 대한 메모를 작성하세요...',
    editorLabel: '메모 편집기',
    addMemo: '메모 추가',
    saveMemo: '메모 저장',
    noMemos: '이 페이지에 메모가 없습니다',
    shared: '공유',
    personal: '개인',
    deleteMemo: '메모 삭제',
    clearPersonal: '개인 메모 지우기',
  ...
  common: {
    ...
    documentation: '문서',
    welcome: '{{name}} 문서에 오신 것을 환영합니다.',
    autoGenerated: '이 문서는 소스 코드 분석을 통해 자동 생성되었습니다.',
    documentationFiles: '문서 파일',
    ...
    classes: '클래스',
    exports: '내보내기',
    completeApiReference: '{{name}}의 전체 API 레퍼런스입니다.',
  },
  theme: {
    returns: '반환값',
    parameters: '파라미터',
...
const ja: I18nStrings = {
  overview: {
    ...
    changelog: '変更履歴',
    components: 'コンポーネント',
    hooksAndServices: 'フック & サービス',
  },
  component: {
    props: 'プロパティ',
    noProps: 'プロパティは定義されていません。',
    methods: 'メソッド',
    dependencies: '依存関係',
  },
  endpoint: {
  ...
  memo: {
    ...
    exportAll: 'すべてエクスポート',
    import: 'インポート',
    importFile: 'メモファイルをインポート',
    placeholder: 'このページのメモを書く...',
    editorLabel: 'メモエディター',
    addMemo: 'メモ追加',
    saveMemo: 'メモ保存',
    noMemos: 'このページにメモはありません',
    shared: '共有',
    personal: '個人',
    deleteMemo: 'メモ削除',
    clearPersonal: '個人メモをクリア',
  ...
  common: {
    ...
    welcome: '{{name}}ドキュメントへようこそ。',
    autoGenerated: 'このドキュメントはソースコード分析から自動生成されました。',
    documentationFiles: 'ドキュメントファイル',
    ...
    classes: 'クラス',
    exports: 'エクスポート',
    completeApiReference: '{{name}}の完全なAPIリファレンスです。',
  },
  theme: {
    returns: '戻り値',
    parameters: 'パラメータ',
...
const zh: I18nStrings = {
  ...
  common: {
    ...
    documentation: '文档',
    welcome: '欢迎来到{{name}}文档。',
    autoGenerated: '本文档通过源代码分析自动生成。',
    ...
    classes: '类',
    exports: '导出',
    completeApiReference: '{{name}}的完整API参考。',
  },
  theme: {
    returns: '返回值',
    parameters: '参数',
...
/**
 * Human-readable locale names for AI prompt instructions
 */
